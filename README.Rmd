...
Future efforts should avoid dependencies on components that are maintained by small user communities with uncertain funding. Therefore reusing those existing solutions for handling images is not recommended.
...
This repository contains a number of files that implement an example solution.
